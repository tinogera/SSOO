...
int main(int argc, char* argv[]) {
    ...
    // -------------------------------------------------------------------
    // 5. Identificarse con tamaño en el payload
    //    Payload: [tamanio: 4 bytes big-endian]
    // -------------------------------------------------------------------
    uint8_t  payload[4];
    ...
    // -------------------------------------------------------------------
    // 7. Aceptar conexiones de CPUs
    //    La CPU envía su ID como payload al identificarse
    // -------------------------------------------------------------------
    while (1) {
        ...
        // Check 2: acá irá el loop de lectura/escritura por CPU
    }

    (void)delay; // se usará en Check 2 para MEMORY_DELAY
